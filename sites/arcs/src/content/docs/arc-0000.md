...
` * sub-category:` _General, Asa, Application, Explorer or Wallet_ optional sub-category header, classifying the ARC into one of the following categories.
...
> ` * replaces:` _ARC number(s)_
> ` * superseded-by:` _ARC number(s)_
...
```json
{
  ...
  "methods": [
    ...
    },
    {
      "name": "arc0_method2",
      "desc": "Method 2",
      "args": [{ "type": "byte[]", "name": "user_data", "desc": "Some characters" }],
      "returns": { "type": "void[]" }
    }
  ]
}
