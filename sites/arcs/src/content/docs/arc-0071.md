...
- The Reserve parameter **MUST** be set to either [ARC-19](/arc-0019) metadata or NTA Issuer's address.
...
[ARC-3](/arc-0003), [ARC-69](/arc-0069), [ARC-19](/arc-0019) ASAs can be converted into a NTA ASA, only if the manager address & freeze address are still available.
