...
This document requires nothing else, but further semantic meaning is prescribed to these functions in [ARC-0010](/arc-0010#semantic-requirements) which builds off of this one and a few others.
...
export type EnableAccountsFunction = (opts?: EnableAccountsOpts) => Promise<EnableAccountsResult>;
